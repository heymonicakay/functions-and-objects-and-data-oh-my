...
![](https://github.com/heymonicakay/client-side-mastery/raw/master/book-3-the-initiate/chapters/images/carlot.png)
...
Then you will use a `for..of` loop to display all the values.
